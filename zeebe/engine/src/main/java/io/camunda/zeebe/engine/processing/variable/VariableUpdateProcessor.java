...
public final class VariableUpdateProcessor implements TypedRecordProcessor<VariableRecord> {
  ...
  public void processRecord(final TypedRecord<VariableRecord> command) {
    ...
    writers.state().appendFollowUpEvent(keyGenerator.nextKey(), VariableIntent.UPDATED, value);
