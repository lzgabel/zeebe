...
public class ZeebeMessageDefinitionImpl extends BpmnModelElementInstanceImpl
    implements ZeebeMessageDefinition {

  private static Attribute<String> messageIdAttribute;
  private static Attribute<String> messageNameAttribute;
  private static Attribute<String> correlationKeyAttribute;
  private static Attribute<String> timeToLiveAttribute;

  public ZeebeMessageDefinitionImpl(final ModelTypeInstanceContext instanceContext) {
  ...
  public static void registerType(final ModelBuilder modelBuilder) {
    final ModelElementTypeBuilder typeBuilder =
        modelBuilder
            .defineType(ZeebeMessageDefinition.class, ZeebeConstants.ELEMENT_MESSAGE_DEFINITION)
            .namespaceUri(BpmnModelConstants.ZEEBE_NS)
            .instanceProvider(ZeebeMessageDefinitionImpl::new);

    messageNameAttribute =
        typeBuilder
            .stringAttribute(ZeebeConstants.ATTRIBUTE_MESSAGE_NAME)
  ...
  public String getMessageName() {
    return messageNameAttribute.getValue(this);
  }

  @Override
  public void setMessageName(final String messageName) {
    messageNameAttribute.setValue(this, messageName);
  }
